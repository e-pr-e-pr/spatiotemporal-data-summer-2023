...
CHANGE BLUE TO HOT PINK IN THIS PLOT TIMESERIES
...
It would be great to find the locations of the stations that FLUXNET does not provide coordinate data for, such that there is more geographic data avilable to analyse. 
