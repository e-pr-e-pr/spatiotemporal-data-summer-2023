...
def process_csv_file(file_path, column_to_analyse, output_dir):
    ...
    Parameters:
        ...
        column_to_analyse (str): The column for which to calculate daily averages. i.e. SWC_1, SWC_2 ...
        output_dir (str): Directory to save the output text file.
    """
    #extract the station name and level from the file name
    file_name = os.path.basename(file_path)
    parts = file_name.split('_')
    station_name = parts[1]
    column_base = column_to_analyse.split('_')[0].lower()
    level = column_to_analyse.split('_')[1]
    ...
    # calculate daily averages and count observations
