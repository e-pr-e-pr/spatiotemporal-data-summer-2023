...
* Select the FLUXNET-CH4 Community pProduct - FLUXNET-CH4 CC-BY-4.0 Data
...
https://fluxnet.org/data/aboutdata/data-variables/ and https://fluxnet.org/data/fluxnet2015-dataset/fullset-data-product/  These pages provides an overview of the data variables found in the data. 

For the station location coordinate data, I got this also from FLUXNET. They didnt have it available to download, but they did have it as a table on the following page: https://fluxnet.org/sites/site-list-and-pages/ . I simply copy and pasted this table into a .csv file to use here in my analysis. 
...
```
The following function plots the results of the above metric claculation visually, on an interactive world map. It uses Plotly, which is an awesome module but pretty complicated. I cant explain everything for it here; I refer the interested reader to the official Plotly website for more information on everything used here! https://plotly.com/python/getting-started/#overview . Also useful are the following : https://www.geeksforgeeks.org/python-plotly-tutorial/
