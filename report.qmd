...
swc_reco_four_levels_metrics = {...}  # Your dictionary data

# Convert metrics dictionary to DataFrame
metrics_df = pd.DataFrame.from_dict(swc_reco_four_levels_metrics, orient='index')
metrics_df.reset_index(inplace=True)
metrics_df.rename(columns={'index': 'station'}, inplace=True)

# Extract location and level from station names in metrics_df
metrics_df[['location', 'level']] = metrics_df['station'].str.split('_', expand=True)

# Merge location data with your metrics
merged_df = metrics_df.merge(df, on='location', how='left')
