...
def create_world_map(df, metrics, levels):
            ...
            dropdown_buttons.append(
                dict(
                    ...
                    args = [{'visible': visible},
                            {'title': f'{metric.capitalize()} between SWC and RECO for Level {level}, all stations'}]
                )
            )
...
fig = create_world_map(swc_reco_merged_df, metrics, levels)
fig.show()
...
print(swc_reco_metrics_df.to_markdown(index=False))
```
