...
```
Now youshould have folders with individual stations and levels as .txt files. This is also the data you will find here in this repo, under /data/RECO/ or /data/SWC/.
...
def create_seasonal_plot_multi_level(data, data_type):
    ...
    fig.update_yaxes(
        title_text=f"{data_type.upper()} (gC m-2 day-1)",
        row=4, col=1
    )
    for i in range(1, 5):
